...
const EXPERTISE = [
 ...
 { icon: '', title: 'AI Governance Frameworks', gov: true,
 ...
 { icon: '', title: 'Enterprise AI Risk', gov: true,
 ...
 { icon: '', title: 'AI Policy & Emerging Regulation', gov: true,
