...
/**
 * ShareBar — social sharing buttons for article pages.
 * @param {string} url - Full canonical URL of the article
 * @param {string} title - Article title
 */
export default function ShareBar({ url, title, postId }) {
 ...
 body: JSON.stringify({ post_id: postId, channel, url }),
 keepalive: true,
 }).catch(() => {});
 };
 ...
 ${copied ? 'bg-green-600' : 'bg-slate-800 hover:bg-slate-700'}`}
